...
public class SalasDAO implements ISalasDAO {
  ...
  String SQInsertarSalas = "INSERT INTO salas(nombre, cantAsientos, tiempoLimpieza, sucursal) VALUES(?, ?, ?, ?)";
    try (Connection conexion = ConexionBD.crearConexion(); 
         PreparedStatement insertarSalasStmt = conexion.prepareStatement(SQInsertarSalas)) {
